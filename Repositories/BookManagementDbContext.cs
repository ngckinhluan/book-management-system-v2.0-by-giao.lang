...
public partial class BookManagementDbContext : DbContext
{
    ...
    public virtual DbSet<Entities.BookCategory> BookCategories { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C20738A615B4");
        ...
        modelBuilder.Entity<Entities.BookCategory>(entity =>
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC04E297822B");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B188762A9D0");
